...
\bioctitle[Harrell Plots]{Combining data, distribution summary, model effects, and uncertainty in
a single plot}
...
\addcontentsline{toc}{subsection}{Harrell plots discourage asterisks and
letters}
